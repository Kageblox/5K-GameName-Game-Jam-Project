class_name MenuColorRect
extends ColorRect
## Tweens from being invisible to the specified color upon its connected menu being opened.

@export var invisible_color: Color = Color(0,0,0,0)
@export var visible_color: Color = Color(0,0,0,0.5)
